...
class GameUI:
    ...
    def show_save_slots(self):
        ...
        slots_frame = ttk.Frame(scrollable)
    ...
    def create_game_interface(self):
        ...
        self.status_bar_frame.pack(in_=scrollable,fill="x", pady=5)
    ...
    def create_control_panel(self, parent):
        ...
        self.create_location_info(scrollable)
        self.create_quick_actions(scrollable)
        self.create_quest_info(scrollable)
