...
class GameWorld:
    ...
    def create_locations(self):
        ...
        self.locations["starting_area"] = Location(
            ...
            terrain="平原", safety_level=7, resources={"food": 3, "water": 3, "materials": 5},
        ...
        self.locations["north_forest"] = Location(
            ...
            terrain="森林", safety_level=4, resources={"food": 5, "water": 2, "wood": 8, "medicine": 2},
        ...
        self.locations["east_river"] = Location(
            ...
            terrain="河流", safety_level=6, resources={"water": 8, "food": 2, "materials": 3},
        ...
        self.locations["south_plains"] = Location(
            ...
            terrain="平原", safety_level=5, resources={"food": 4, "water": 3, "materials": 4},
        ...
        self.locations["deep_forest"] = Location(
            ...
            terrain="森林", safety_level=2, resources={"wood": 10, "medicine": 4, "rare_herbs": 2},
        ...
        self.locations["mountain_foot"] = Location(
            ...
            terrain="山地", safety_level=5, resources={"stone": 6, "materials": 4, "water": 2},
        ...
        self.locations["river_source"] = Location(
            ...
            terrain="山地", safety_level=7, resources={"water": 10, "rare_minerals": 3},
        ...
        self.locations["fishing_spot"] = Location(
            ...
            terrain="河流", safety_level=6, resources={"food": 6, "water": 5},
        ...
        self.locations["abandoned_farm"] = Location(
            ...
            terrain="农田", safety_level=4, resources={"food": 8, "materials": 6, "seeds": 4},
        ...
        self.locations["old_road"] = Location(
            ...
            terrain="道路", safety_level=5, resources={"materials": 3, "electronic": 2},
        ...
        self.locations["ancient_ruins"] = Location(
            ...
            terrain="遗迹", safety_level=3, resources={"ancient_artifacts": 5, "stone": 4},
        ...
        self.locations["mountain_path"] = Location(
            ...
            terrain="山地", safety_level=4, resources={"stone": 5, "rare_herbs": 3},
        ...
        self.locations["farmhouse"] = Location(
            ...
            terrain="建筑", safety_level=6, resources={"food": 4, "materials": 8, "cloth": 5},
        ...
        self.locations["trading_post"] = Location(
            ...
            terrain="建筑", safety_level=8, resources={"various": 10},
        ...
        self.locations["survivor_camp"] = Location(
            ...
            terrain="营地", safety_level=9, resources={"food": 3, "water": 4, "medicine": 3},
        ...
        self.locations["mountain_peak"] = Location(
            ...
            terrain="山地", safety_level=6, resources={"rare_minerals": 5, "strategic_view": 1},
    ...
    def _enemy_event(self, location):
        ...
        if safety >= 7:
            pool = [
                {'id': 'mutant_rat', 'name': '变异鼠', 'health': 20, 'attack': 5, 'defense': 2, 'loot': {'food': 1}},
                {'id': 'radroach', 'name': '辐射蟑螂', 'health': 15, 'attack': 4, 'defense': 3, 'loot': {'materials': 2}}
            ]
        elif safety >= 5:
            pool = [
                {'id': 'mutant_wolf', 'name': '变异狼', 'health': 30, 'attack': 8, 'defense': 3, 'loot': {'food': 2, 'materials': 1}},
                {'id': 'zombie', 'name': '僵尸', 'health': 40, 'attack': 6, 'defense': 5, 'loot': {'cloth': 3}}
            ]
        elif safety >= 3:
            pool = [
                {'id': 'giant_spider', 'name': '巨型蜘蛛', 'health': 35, 'attack': 12, 'defense': 2, 'loot': {'medicine': 2, 'materials': 2}},
                {'id': 'radscorpion', 'name': '辐射蝎子', 'health': 55, 'attack': 18, 'defense': 7, 'loot': {'antidote': 1, 'rare_minerals': 1}}
            ]
        else:
            pool = [
                {'id': 'mutant_bear', 'name': '变异熊', 'health': 60, 'attack': 15, 'defense': 8, 'loot': {'food': 3, 'materials': 4}},
                {'id': 'raider_elite', 'name': '掠夺者精英', 'health': 50, 'attack': 12, 'defense': 6, 'loot': {'electronic': 2, 'materials': 5}}
            ]
    ...
    def _discovery_event(self, location):
        ...
        if undiscovered:
            ...
            return {'type': 'discovery', 'location': new_loc, 'message': f"发现了一个新的地点：{new_loc.name}"}
        else:
