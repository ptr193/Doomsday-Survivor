...
class QuestSystem:
    ...
    def create_quests(self):
        ...
        self.quests['epic_01'] = {'id': 'epic_01', 'name': '蚀日讨伐', 'category': 'epic', 'difficulty': 8, 'description': '传说中的变异巨兽在废土深处苏醒。击杀它，才能证明你配得上史诗之名。', 'objectives': [{'id': 'slay_behemoth', 'description': '击败变异巨兽', 'type': 'defeat_enemies', 'target': 'mutant_behemoth', 'required': 1, 'current': 0}], 'prerequisites': ['main_01', 'main_02', 'main_03'], 'rewards': {'exp': 800, 'items': {'advanced_alloy': 3, 'ancient_artifact': 1, 'military_ration': 5}, 'money': 500, 'unlocks': ['epic_02']}, 'time_limit': None, 'repeatable': False, 'giver_npc': 'system', 'story_text': '巨兽踏过的地方，连辐射尘都会安静片刻。'}
        self.quests['epic_02'] = {'id': 'epic_02', 'name': '红色黎明', 'category': 'epic', 'difficulty': 9, 'description': '深入研究实验室，击败锈蚀巨像，收集红色黎明的最终记录。', 'objectives': [{'id': 'enter_lab', 'description': '抵达研究实验室', 'type': 'explore_location', 'target': 'research_lab', 'required': 1, 'current': 0}, {'id': 'slay_colossus', 'description': '击败锈蚀巨像', 'type': 'defeat_enemies', 'target': 'rust_colossus', 'required': 1, 'current': 0}, {'id': 'read_dawn', 'description': '阅读红色黎明残卷', 'type': 'read_document', 'target': 'red_dawn_01', 'required': 1, 'current': 0}], 'prerequisites': ['epic_01'], 'rewards': {'exp': 1200, 'items': {'ancient_artifact': 1, 'radiation_pills': 3, 'research_data': 2}, 'money': 800}, 'time_limit': None, 'repeatable': False, 'giver_npc': 'system', 'story_text': '当警报再次响起时，你才明白红色从来不是朝霞。'}
    ...
    def is_epic_quest(self, quest_id):
        quest = self.quests.get(quest_id)
        return bool(quest and quest.get('category') == 'epic')
    ...
    def get_quest_giver_name(self, giver_id):
        names = {'system': '系统', 'old_farmer': '老农民张大爷', 'doctor_li': '李医生', 'security_chief': '王队长', 'cartographer': '地图绘制师', 'master_crafter': '工匠大师', 'radio_op_chen': '电台员小陈', 'fisher_hai': '渔夫老海'}
