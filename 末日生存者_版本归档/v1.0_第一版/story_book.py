...
"""
        ...
        self.stories['origin_02'] = {
            ...
            'author': '李静 - 央视新闻主播',
            'category': 'origin',
            'unlock_condition': 'survive_3_days',
            'content': """
...
"""
        ...
        self.stories['timeline_01'] = {
            ...
            'author': '匿名幸存者',
            'category': 'timeline',
            'unlock_condition': 'survive_7_days',
            'content': """
灾难后第一周：
...
"""
        ...
        self.stories['timeline_02'] = {
            ...
            'author': '前消防员 - 老张',
            'category': 'timeline',
            'unlock_condition': 'survive_30_days',
            'content': """
灾难后第一个月：
...
"""
        ...
        self.stories['timeline_03'] = {
            ...
            'author': '农夫 - 李大爷',
            'category': 'timeline',
            'unlock_condition': 'harvest_first_crop',
            'content': """
灾难后第一年：
...
"""
        ...
        self.stories['timeline_04'] = {
            ...
            'author': '教师 - 王老师',
            'category': 'timeline',
            'unlock_condition': 'survive_1_year',
            'content': """
灾难后第五年：
...
"""
        ...
        self.stories['location_01'] = {
            ...
            'author': '地铁幸存者团体',
            'category': 'location',
            'unlock_condition': 'explore_subway',
            'content': """
...
"""
        ...
        self.stories['location_02'] = {
            ...
            'author': '高空观察者',
            'category': 'location',
            'unlock_condition': 'explore_city_center',
            'content': """
...
"""
        ...
        self.stories['location_03'] = {
            ...
            'author': '农业社区记录',
            'category': 'location',
            'unlock_condition': 'discover_farmland',
            'content': """
...
"""
        ...
        self.stories['location_04'] = {
            ...
            'author': '高原守望者',
            'category': 'location',
            'unlock_condition': 'reach_high_altitude',
            'content': """
海拔保护了我们，辐射云层在脚下翻涌。
...
"""
        ...
        self.stories['character_01'] = {
            ...
            'author': '王队长',
            'category': 'character',
            'unlock_condition': 'meet_security_chief',
            'content': """
...
"""
        ...
        self.stories['character_02'] = {
            ...
            'author': '张明博士',
            'category': 'character',
            'unlock_condition': 'find_research_data',
            'content': """
...
"""
        ...
        self.stories['mystery_01'] = {
            ...
            'author': '探险队报告',
            'category': 'mystery',
            'unlock_condition': 'explore_forest_at_night',
            'content': """
在郊外的辐射区内，树木发出了诡异的绿光。
...
"""
        ...
        self.stories['mystery_02'] = {
            ...
            'author': '物理学家笔记',
            'category': 'mystery',
            'unlock_condition': 'discover_anomaly',
            'content': """
...
"""
        ...
        self.stories['mystery_03'] = {
            ...
            'author': '隧道勘探记录',
            'category': 'mystery',
            'unlock_condition': 'explore_deep_tunnel',
            'content': """
...
"""
        ...
        self.stories['guide_01'] = {
            ...
            'author': '老农民李大爷',
            'category': 'guide',
            'unlock_condition': 'learn_farming',
            'content': """
末世种地三要素：好土、好种、好心态。
...
"""
        ...
        self.stories['guide_02'] = {
            ...
            'author': '张医生',
            'category': 'guide',
            'unlock_condition': 'learn_healing',
            'content': """
...
"""
        ...
        self.stories['guide_03'] = {
            ...
            'author': '工匠王师傅',
            'category': 'guide',
            'unlock_condition': 'learn_crafting',
            'content': """
东西坏了不要扔，修修补补又三年。
...
"""
    ...
    def check_unlock_conditions(self, condition):
        ...
        for story_id, story in self.stories.items():
            if (story_id not in self.unlocked_stories and 
                story['unlock_condition'] == condition):
                if self.unlock_story(story_id):
    ...
    def get_unlocked_stories(self):
        """获取已解锁的故事"""
        unlocked = []
        for story_id in self.unlocked_stories:
            if story_id in self.stories:
                unlocked.append(self.stories[story_id])
        return unlocked
    ...
    def get_stories_by_category(self, category):
        ...
        for story in self.stories.values():
            if story['category'] == category and story['id'] in self.unlocked_stories:
